...
<head>
    ...
    <title>@yield('title', 'Portfolio - Company Showcase')</title>
            ...
            <div class="nav-wrapper">
                <div class="logo">
                    <a href="{{ route('portfolio') }}">
                        <span class="logo-text">Elegante</span>
                    </a>
                </div>
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-section">
                    <h3 class="footer-title">Elegante</h3>
            ...
            <div class="footer-bottom">
                <p>&copy; 2024 Elegante. All rights reserved. | Designed with <i class="fas fa-heart"></i></p>
            </div>
        </div>
    </footer>
