...
<section class="about-stats" id="about-stats">
    <div class="container">
        <div class="about-stats__header text-center mb-5">
        ...
        <div class="row g-4 justify-content-center">
            <div class="col-6 col-md-3">
                <div class="about-stats__card" data-aos="zoom-in" data-aos-delay="0">
            ...
            <div class="col-6 col-md-3">
                <div class="about-stats__card" data-aos="zoom-in" data-aos-delay="100">
                    <div class="about-stats__icon">
            ...
            <div class="col-6 col-md-3">
                <div class="about-stats__card" data-aos="zoom-in" data-aos-delay="200">
                    <div class="about-stats__icon">
            ...
            <div class="col-6 col-md-3">
                <div class="about-stats__card" data-aos="zoom-in" data-aos-delay="300">
                    <div class="about-stats__icon">
...
<section class="about-services" id="services">
    <div class="container">
        <div class="about-services__header text-center mb-5" data-aos="fade-up">
...
<section class="about-why" id="why-us">
    <div class="container">
        <div class="about-why__header text-center mb-5" data-aos="fade-up">
...
<section class="about-cta" id="contact-cta">
    ...
    <div class="container">
        <div class="about-cta__inner text-center" data-aos="zoom-in">
